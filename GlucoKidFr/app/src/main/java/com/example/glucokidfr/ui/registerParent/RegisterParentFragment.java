...
public class RegisterParentFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(RegisterParentViewModel.class);
        ...
        viewModel.getRegisterResult().observe(getViewLifecycleOwner(), parent -> {
            if (parent != null) {
        ...
        btnRegister.setOnClickListener(v -> {
            ...
            tvError.setVisibility(View.GONE);
            viewModel.register(firstName, lastName, patronymic, phone, password);
        });

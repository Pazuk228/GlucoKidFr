...
public class RegisterChildFragment extends Fragment {
    ...
    private RegisterChildViewModel viewModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(RegisterChildViewModel.class);
        ...
        viewModel.getRegisterResult().observe(getViewLifecycleOwner(), child -> {
            if (child != null) {
        ...
        btnRegister.setOnClickListener(v -> {
            ...
            viewModel.register(firstName, lastName, patronymic, email, password);
        });
